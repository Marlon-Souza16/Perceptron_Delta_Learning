...
![Aprendzado_Delta](https://latex.codecogs.com/png.image?\inline&space;\large&space;\dpi{300}\bg{white}\Delta&space;w=c\cdot(d-o)\cdot\text{derivada\_de\_ativacao&space;)
